...
def _render_size(
    ...
    *,
    ...
    return pixel_size, line_count, buffer, has_wrapped
...
def render_size(
    ...
    *,
    ...
    pixel_size, line_count, buffer, has_wrapped = _render_size(
        text,
        font=font,
        size=size,
        spacing=spacing,
...
def check_render_size(
    *,
    ...
    """Check whether rendered text fits."""
    rendered_size, actual_lines, has_wrapped = render_size(
        font=font,
        weight=weight,
        size=size,
        spacing=spacing,
    ...
    return rendered_size.width <= width and actual_lines <= lines and not has_wrapped
